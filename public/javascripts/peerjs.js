    ...
    window.RTCPeerConnection.prototype.removeTrack = function removeTrack(
      ...
      if (stream) {
        if (stream.getTracks().length === 1)
          ...
          this.removeStream(this._reverseStreams[stream.id]); // relying on the same odd chrome behaviour as above.
      ...
      if (browserDetails.browser === "firefox") {
        if (browserDetails.version < 57) {
          if (remoteIsFirefox === -1)
            ...
            // fragmentation.
            canSendMaxMessageSize = 16384; // However, other FF (and RAWRTC) can reassemble PPID-fragmented
          else
          ...
          canSendMaxMessageSize = browserDetails.version === 57 ? 65535 : 65536; // FF >= 60 supports sending ~2 GiB
