!(function (t, e) {
  ...
  class V {
    ...
    moveToTop() {
      if (!this.parent)
        return (
          g.warn("Node has no parent. moveToTop function is ignored."),
          !1
        );
      const t = this.index;
      return (
    ...
    moveDown() {
      if (!this.parent)
        return (
          g.warn("Node has no parent. moveDown function is ignored."),
          !1
        );
      const t = this.index;
      return (
    ...
    moveToBottom() {
      if (!this.parent)
        return (
          g.warn("Node has no parent. moveToBottom function is ignored."),
          !1
        );
      const t = this.index;
      return (
    ...
    setZIndex(t) {
      if (!this.parent)
        return (
          g.warn("Node has no parent. zIndex parameter is ignored."),
          this
        );
  ...
  class Jt {
    constructor(t) {
      ...
      let o, h;
      ((o =
        void 0 === t.duration ? 0.3 : 0 === t.duration ? 0.001 : t.duration),
        (this.node = n),
        (this._id = Kt++));
  ...
  class ge extends Nt {
    ...
    static getPointAtLengthOfDataArray(t, e) {
      ...
      if (n === s)
        return ((i = e[n - 1].points.slice(-2)), { x: i[0], y: i[1] });
      if (t < 0.01)
        return ((i = e[n].points.slice(0, 2)), { x: i[0], y: i[1] });
      const r = e[n],
        a = r.points;
      switch (r.command) {
        case "L":
  ...
  class ri extends Xt {
    ...
    setNodes(t = []) {
      ...
      ((this._nodes = t = e),
        ...
        this._nodes.forEach((t) => {
          ...
          (t.on(i, e),
            t.on(
              $e.map((t) => t + `.${this._getEventNamespace()}`).join(" "),
              e,
            ),
    ...
    _handleMouseMove(t) {
      ...
      if ("top-left" === this._movingAnchorName) {
        ...
        var _ = r.position();
        (this.findOne(".top-left").y(_.y),
          this.findOne(".bottom-right").x(_.x));
