(() => {
  ...
  function N(e, t) {
    if (!e.RTCPeerConnection) return;
    if (e.RTCPeerConnection.prototype.addTrack && t.version >= 65) return z(e);
  ...
  (e(j, "shimMediaStream", () => A),
    e(j, "shimOnTrack", () => B),
    e(j, "shimGetSendersWithDtmf", () => F),
    e(j, "shimSenderReceiverGetStats", () => U),
    e(j, "shimAddTrackRemoveTrackWithNative", () => z),
    e(j, "shimAddTrackRemoveTrack", () => N),
    e(j, "shimPeerConnection", () => $),
    e(j, "fixNegotiationNeeded", () => J),
  ...
  (e(V, "shimOnTrack", () => H),
    e(V, "shimPeerConnection", () => Y),
    e(V, "shimSenderGetStats", () => K),
    e(V, "shimReceiverGetStats", () => X),
    e(V, "shimRemoveStream", () => q),
    e(V, "shimRTCDataChannel", () => Q),
    e(V, "shimAddTransceiver", () => Z),
    e(V, "shimGetParameters", () => ee),
    e(V, "shimCreateOffer", () => et),
    e(V, "shimCreateAnswer", () => en),
    e(V, "shimGetUserMedia", () => G),
    e(V, "shimGetDisplayMedia", () => W));
  var er = {};
  function ei(e) {
  ...
  function ea(e) {
    ...
    if (t.mediaDevices && t.mediaDevices.getUserMedia) {
      ...
      t.mediaDevices.getUserMedia = (e) => n(ec(e));
    }
    !t.getUserMedia &&
      t.mediaDevices &&
  ...
  (e(er, "shimLocalStreamsAPI", () => ei),
    e(er, "shimRemoteStreamsAPI", () => eo),
    e(er, "shimCallbacksAPI", () => es),
    e(er, "shimGetUserMedia", () => ea),
    e(er, "shimConstraints", () => ec),
    e(er, "shimRTCIceServerUrls", () => el),
    e(er, "shimTrackEventTransceiver", () => ep),
    e(er, "shimCreateOfferLegacy", () => ed),
    e(er, "shimAudioContext", () => eh));
  var eu = {};
  (e(eu, "shimRTCIceCandidate", () => eg),
    e(eu, "shimRTCIceCandidateRelayProtocol", () => ey),
    e(eu, "shimMaxMessageSize", () => e_),
    e(eu, "shimSendThrowTypeError", () => eC),
    e(eu, "shimConnectionState", () => eb),
    e(eu, "removeExtmapAllowMixed", () => ev),
    e(eu, "shimAddIceCandidateNullOrEmpty", () => ek),
    e(eu, "shimParameterlessSetLocalDescription", () => eT));
  var ef = {};
  let em = {};
  function eg(e) {
    if (
    ...
    ((e.RTCIceCandidate = function (e) {
      if (
        ...
        let r = new n(e),
          i = t(ef).parseCandidate(e.candidate);
  ...
  function ey(e) {
    !e.RTCIceCandidate ||
      ...
      d(e, "icecandidate", (e) => {
        if (e.candidate) {
          let n = t(ef).parseCandidate(e.candidate.candidate);
          "relay" === n.type &&
  ...
  function e_(e, n) {
    ...
    let r = function (e) {
        if (!e || !e.sdp) return !1;
        let n = t(ef).splitSections(e.sdp);
        return (
          n.shift(),
          n.some((e) => {
            let n = t(ef).parseMLine(e);
            return (
      ...
      s = function (e, r) {
        ...
        let o = t(ef).matchPrefix(e.sdp, "a=max-message-size:");
        return (
          o.length > 0
  ...
  ((em.generateIdentifier = function () {
    return Math.random().toString(36).substring(2, 12);
  }),
    (em.localCName = em.generateIdentifier()),
    (em.splitLines = function (e) {
      return e
        .trim()
        .split("\n")
        .map((e) => e.trim());
    }),
    (em.splitSections = function (e) {
      return e
        .split("\nm=")
        .map((e, t) => (t > 0 ? "m=" + e : e).trim() + "\r\n");
    }),
    (em.getDescription = function (e) {
      let t = em.splitSections(e);
      return t && t[0];
    }),
    (em.getMediaSections = function (e) {
      let t = em.splitSections(e);
      return (t.shift(), t);
    }),
    (em.matchPrefix = function (e, t) {
      return em.splitLines(e).filter((e) => 0 === e.indexOf(t));
    }),
    (em.parseCandidate = function (e) {
      let t;
      let n = {
        foundation: (t =
    ...
    (em.parseIceOptions = function (e) {
      return e.substring(14).split(" ");
    }),
    (em.parseRtpMap = function (e) {
    ...
    (em.writeCryptoLine = function (e) {
      return (
        ...
        ("object" == typeof e.keyParams
          ? em.writeCryptoKeyParams(e.keyParams)
          : e.keyParams) +
        (e.sessionParams ? " " + e.sessionParams.join(" ") : "") +
        "\r\n"
      );
    }),
    (em.parseCryptoKeyParams = function (e) {
    ...
    (em.writeCryptoKeyParams = function (e) {
      return (
        e.keyMethod +
        ":" +
        e.keySalt +
    ...
    (em.getCryptoParameters = function (e, t) {
      return em.matchPrefix(e + t, "a=crypto:").map(em.parseCryptoLine);
    }),
    (em.getIceParameters = function (e, t) {
      let n = em.matchPrefix(e + t, "a=ice-ufrag:")[0],
        r = em.matchPrefix(e + t, "a=ice-pwd:")[0];
      return n && r
        ? { usernameFragment: n.substring(12), password: r.substring(10) }
        : null;
    }),
    (em.writeIceParameters = function (e) {
      let t =
        "a=ice-ufrag:" +
        e.usernameFragment +
        "\r\na=ice-pwd:" +
    ...
    (em.parseRtpParameters = function (e) {
      let t = { codecs: [], headerExtensions: [], fecMechanisms: [], rtcp: [] },
        n = em.splitLines(e)[0].split(" ");
      t.profile = n[2];
      for (let r = 3; r < n.length; r++) {
        let i = n[r],
          o = em.matchPrefix(e, "a=rtpmap:" + i + " ")[0];
        if (o) {
          let n = em.parseRtpMap(o),
            r = em.matchPrefix(e, "a=fmtp:" + i + " ");
          switch (
            ((n.parameters = r.length ? em.parseFmtp(r[0]) : {}),
            (n.rtcpFeedback = em
      ...
      em.matchPrefix(e, "a=extmap:").forEach((e) => {
        t.headerExtensions.push(em.parseExtmap(e));
      });
      let r = em.matchPrefix(e, "a=rtcp-fb:* ").map(em.parseRtcpFb);
      return (
        t.codecs.forEach((e) => {
          r.forEach((t) => {
            e.rtcpFeedback.find(
    ...
    (em.writeRtpDescription = function (e, t) {
      let n = "";
      ((n +=
        "m=" +
        e +
        ...
        t.codecs.forEach((e) => {
          n += em.writeRtpMap(e) + em.writeFmtp(e) + em.writeRtcpFb(e);
        }));
      let r = 0;
      return (
        t.codecs.forEach((e) => {
    ...
    (em.parseRtcpParameters = function (e) {
      let t = {},
        n = em
          .matchPrefix(e, "a=ssrc:")
          .map((e) => em.parseSsrcMedia(e))
      ...
      let r = em.matchPrefix(e, "a=rtcp-rsize");
      ((t.reducedSize = r.length > 0), (t.compound = 0 === r.length));
      let i = em.matchPrefix(e, "a=rtcp-mux");
      return ((t.mux = i.length > 0), t);
    }),
    (em.writeRtcpParameters = function (e) {
      let t = "";
      return (
    ...
    (em.parseMsid = function (e) {
      let t;
      let n = em.matchPrefix(e, "a=msid:");
      if (1 === n.length)
    ...
    (em.parseSctpDescription = function (e) {
      let t;
      let n = em.parseMLine(e),
        r = em.matchPrefix(e, "a=max-message-size:");
      (r.length > 0 && (t = parseInt(r[0].substring(19), 10)),
        isNaN(t) && (t = 65536));
      let i = em.matchPrefix(e, "a=sctp-port:");
      if (i.length > 0)
        return {
    ...
    (em.generateSessionId = function () {
      return Math.random().toString().substr(2, 22);
    }),
    (em.writeSessionBoilerplate = function (e, t, n) {
      return (
        "v=0\r\no=" +
        (n || "thisisadapterortc") +
        " " +
        (e || em.generateSessionId()) +
        " " +
        (void 0 !== t ? t : 2) +
        " IN IP4 127.0.0.1\r\ns=-\r\nt=0 0\r\n"
      );
    }),
    (em.getDirection = function (e, t) {
      let n = em.splitLines(e);
      ...
      return t ? em.getDirection(t) : "sendrecv";
    }),
    (em.getKind = function (e) {
      return em.splitLines(e)[0].split(" ")[0].substring(2);
    }),
    (em.isRejected = function (e) {
      return "0" === e.split(" ", 2)[1];
    }),
    (em.parseMLine = function (e) {
      let t = em.splitLines(e)[0].substring(2).split(" ");
      return {
        kind: t[0],
    ...
    (em.parseOLine = function (e) {
      let t = em.matchPrefix(e, "o=")[0].substring(2).split(" ");
      return {
        username: t[0],
        sessionId: t[1],
    ...
    (em.isValidSDP = function (e) {
      if ("string" != typeof e || 0 === e.length) return !1;
      let t = em.splitLines(e);
  ...
  let eS = (function (
      ...
      let n = (function (e) {
          ...
          if (n.userAgentData && n.userAgentData.brands) {
            ...
            if (e)
              return { browser: "chrome", version: parseInt(e.version, 10) };
          }
          return (
            n.mozGetUserMedia
              ? ((t.browser = "firefox"),
      ...
      switch (n.browser) {
        case "chrome":
          ...
          break;
        case "firefox":
          if (!V || !V.shimPeerConnection || !t.shimFirefox) {
          ...
          (f("adapter.js shimming firefox."),
            ...
            V.shimOnTrack(e, n),
            V.shimRemoveStream(e, n),
            V.shimSenderGetStats(e, n),
            V.shimReceiverGetStats(e, n),
            V.shimRTCDataChannel(e, n),
            V.shimAddTransceiver(e, n),
            V.shimGetParameters(e, n),
            V.shimCreateOffer(e, n),
            V.shimCreateAnswer(e, n),
            eg(e, n),
            eb(e, n),
            e_(e, n),
            eC(e, n));
        ...
        case "safari":
          ...
          (f("adapter.js shimming safari."),
            ...
            ek(e, n),
            eT(e, n),
            er.shimRTCIceServerUrls(e, n),
            er.shimCreateOfferLegacy(e, n),
            er.shimCallbacksAPI(e, n),
            er.shimLocalStreamsAPI(e, n),
            er.shimRemoteStreamsAPI(e, n),
            er.shimTrackEventTransceiver(e, n),
            er.shimGetUserMedia(e, n),
            er.shimAudioContext(e, n),
            eg(e, n),
            ey(e, n),
            e_(e, n),
            eC(e, n),
    ...
    eP = new (class {
      ...
      getBrowser() {
        return eR.browserDetails.browser;
      }
      getVersion() {
        return eR.browserDetails.version || 0;
      }
      isUnifiedPlanSupported() {
        let e;
        let t = this.getBrowser(),
          n = eR.browserDetails.version || 0;
    ...
    ew = (e) => !e || /^[A-Za-z0-9]+(?:[ _-][A-Za-z0-9]+)*$/.test(e),
    ...
    ex = new (class extends n {
      ...
      constructor(...e) {
        (super(...e),
          ...
          (this.defaultConfig = eD),
          (this.browser = eP.getBrowser()),
          (this.browserVersion = eP.getVersion()),
          (this.pack = o),
          (this.unpack = i),
          (this.supports = (function () {
            let e;
            let t = {
              browser: eP.isBrowserSupported(),
              webRTC: eP.isWebRTCSupported(),
              audioVideo: !1,
              data: !1,
              binaryBlob: !1,
              reliable: !1,
            ...
            try {
              let n;
              ((e = new RTCPeerConnection(eD)), (t.audioVideo = !0));
              try {
                ((n = e.createDataChannel("_PEERJSTEST", { ordered: !0 })),
                  (t.data = !0),
                  (t.reliable = !!n.ordered));
                try {
                  ((n.binaryType = "blob"), (t.binaryBlob = !eP.isIOS));
                } catch (e) {}
              } catch (e) {
              } finally {
                n && n.close();
  ...
  function eF(e, t) {
    0 == --e._eventsCount ? (e._events = new eL()) : delete e._events[t];
  }
  function eU() {
    ((this._events = new eL()), (this._eventsCount = 0));
  }
  (Object.create &&
    ((eL.prototype = Object.create(null)), new eL().__proto__ || (ej = !1)),
    (eU.prototype.eventNames = function () {
      var e,
        t,
        n = [];
      if (0 === this._eventsCount) return n;
      for (t in (e = this._events))
        eO.call(e, t) && n.push(ej ? t.slice(1) : t);
      return Object.getOwnPropertySymbols
        ? n.concat(Object.getOwnPropertySymbols(e))
        : n;
    }),
    (eU.prototype.listeners = function (e) {
      var t = ej ? ej + e : e,
        n = this._events[t];
      if (!n) return [];
      if (n.fn) return [n.fn];
    ...
    (eU.prototype.listenerCount = function (e) {
      var t = ej ? ej + e : e,
        n = this._events[t];
      return n ? (n.fn ? 1 : n.length) : 0;
    }),
    (eU.prototype.emit = function (e, t, n, r, i, o) {
      var s = ej ? ej + e : e;
    ...
    (eU.prototype.on = function (e, t, n) {
      return eB(this, e, t, n, !1);
    }),
    (eU.prototype.once = function (e, t, n) {
      return eB(this, e, t, n, !0);
    }),
    (eU.prototype.removeListener = function (e, t, n, r) {
      var i = ej ? ej + e : e;
      if (!this._events[i]) return this;
      if (!t) return (eF(this, i), this);
      var o = this._events[i];
      if (o.fn)
        o.fn !== t || (r && !o.once) || (n && o.context !== n) || eF(this, i);
      else {
        for (var s = 0, a = [], c = o.length; s < c; s++)
          (o[s].fn !== t || (r && !o[s].once) || (n && o[s].context !== n)) &&
            a.push(o[s]);
        a.length ? (this._events[i] = 1 === a.length ? a[0] : a) : eF(this, i);
      }
      return this;
    }),
    (eU.prototype.removeAllListeners = function (e) {
      var t;
      return (
        e
          ? ((t = ej ? ej + e : e), this._events[t] && eF(this, t))
          : ((this._events = new eL()), (this._eventsCount = 0)),
        this
      );
    }),
    (eU.prototype.off = eU.prototype.removeListener),
    (eU.prototype.addListener = eU.prototype.on),
    (eU.prefixed = ej),
    (eU.EventEmitter = eU),
    (eM = eU),
    ((C = w || (w = {})).Data = "data"),
    (C.Media = "media"),
    ((b = E || (E = {})).BrowserIncompatible = "browser-incompatible"),
    (b.Disconnected = "disconnected"),
    (b.InvalidID = "invalid-id"),
    (b.InvalidKey = "invalid-key"),
    (b.Network = "network"),
    (b.PeerUnavailable = "peer-unavailable"),
    (b.SslUnavailable = "ssl-unavailable"),
    (b.ServerError = "server-error"),
    (b.SocketError = "socket-error"),
    (b.SocketClosed = "socket-closed"),
    (b.UnavailableID = "unavailable-id"),
    (b.WebRTC = "webrtc"),
    ((v = D || (D = {})).NegotiationFailed = "negotiation-failed"),
    (v.ConnectionClosed = "connection-closed"),
    ((k = x || (x = {})).NotOpenYet = "not-open-yet"),
    (k.MessageToBig = "message-too-big"),
    ((T = I || (I = {})).Binary = "binary"),
    (T.BinaryUTF8 = "binary-utf8"),
    (T.JSON = "json"),
    (T.None = "raw"),
    ((S = M || (M = {})).Message = "message"),
  ...
  class eN extends eM.EventEmitter {
    start(e, t) {
      this._id = e;
      let n = `${this._baseUrl}&id=${e}&token=${t}`;
      !this._socket &&
        this._disconnected &&
        ((this._socket = new WebSocket(n + "&version=" + ez.version)),
        (this._disconnected = !1),
        (this._socket.onmessage = (e) => {
          let t;
          try {
            ((t = JSON.parse(e.data)), eI.log("Server message received:", t));
          } catch (t) {
            eI.log("Invalid server message", e.data);
            return;
          }
    ...
    _sendHeartbeat() {
      if (!this._wsOpen()) {
        eI.log("Cannot send heartbeat, because socket closed");
        return;
      }
  ...
  class e$ {
    ...
    _startPeerConnection() {
      eI.log("Creating RTCPeerConnection.");
    ...
    _setupListeners(e) {
      ...
      (eI.log("Listening for ICE candidates."),
        (e.onicecandidate = (e) => {
          e.candidate &&
            e.candidate.candidate &&
            (eI.log(`Received ICE candidates for ${t}:`, e.candidate),
            i.socket.send({
              type: O.Candidate,
        ...
        eI.log("Listening for data channel"),
        (e.ondatachannel = (e) => {
          eI.log("Received data channel");
          let r = e.channel;
          i.getConnection(t, n)._initializeDataChannel(r);
        }),
        eI.log("Listening for remote stream"),
        (e.ontrack = (e) => {
          eI.log("Received remote stream");
          let r = e.streams[0],
            o = i.getConnection(t, n);
          o.type === w.Media && this._addStreamToMediaConnection(r, o);
        }));
    }
    cleanup() {
      eI.log("Cleaning up PeerConnection to " + this.connection.peer);
      ...
      try {
        ...
        try {
          (await e.setLocalDescription(n),
            eI.log("Set localDescription:", n, `for:${this.connection.peer}`));
          let r = {
            sdp: n,
          ...
          "OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer" !=
            ...
            eI.log("Failed to setLocalDescription, ", e));
        }
      } catch (e) {
        (t.emitError(E.WebRTC, e), eI.log("Failed to createOffer, ", e));
      }
    }
    async _makeAnswer() {
      let e = this.connection.peerConnection,
      ...
      try {
        ...
        (t.emitError(E.WebRTC, e), eI.log("Failed to create answer, ", e));
      }
    }
    async handleSDP(e, t) {
      ...
      eI.log("Setting remote description", t);
      try {
        (await n.setRemoteDescription(t),
          eI.log(`Set remoteDescription:${e} for:${this.connection.peer}`),
          "OFFER" === e && (await this._makeAnswer()));
      } catch (e) {
        (r.emitError(E.WebRTC, e),
          eI.log("Failed to setRemoteDescription, ", e));
      }
    }
    async handleCandidate(e) {
      eI.log("handleCandidate:", e);
      try {
        (await this.connection.peerConnection.addIceCandidate(e),
          eI.log(`Added ICE candidate for:${this.connection.peer}`));
      } catch (e) {
        (this.connection.provider.emitError(E.WebRTC, e),
          eI.log("Failed to handleCandidate, ", e));
      }
    }
    _addTracksToConnection(e, t) {
      if (
        (eI.log(`add tracks from stream ${e.id} to peer connection`),
        !t.addTrack)
      )
        return eI.error(
    ...
    _addStreamToMediaConnection(e, t) {
      (eI.log(`add stream ${e.id} to media connection ${t.connectionId}`),
        t.addStream(e));
    }
    constructor(e) {
      this.connection = e;
  ...
  class eJ extends eM.EventEmitter {
    emitError(e, t) {
      (eI.error("Error:", t), this.emit("error", new eV(`${e}`, t)));
    }
  }
  ...
  class eW extends eG {
    ...
    _initializeDataChannel(e) {
      ((this.dataChannel = e),
        (this.dataChannel.onopen = () => {
          (eI.log(`DC#${this.connectionId} dc connection success`),
            this.emit("willCloseOnRemote"));
        }),
        (this.dataChannel.onclose = () => {
          (eI.log(`DC#${this.connectionId} dc closed for:`, this.peer),
            this.close());
        }));
    }
    addStream(e) {
      (eI.log("Receiving stream", e),
    ...
    handleMessage(e) {
      ...
      switch (e.type) {
        ...
        case O.Candidate:
          ...
          break;
        default:
          eI.warn(`Unrecognized message type:${t} from peer:${this.peer}`);
      }
    }
    answer(e, t = {}) {
    ...
    constructor(e, t, n) {
      (super(e, t, n),
        ...
        (this.connectionId =
          this.options.connectionId || eW.ID_PREFIX + ex.randomToken()),
        (this._negotiator = new e$(this)),
        this._localStream &&
          this._negotiator.startConnection({
  ...
  class eH {
    _buildRequest(e) {
      ...
      return (
        ...
        s.searchParams.set("version", ez.version),
    ...
    async retrieveId() {
      try {
        ...
        eI.error("Error retrieving ID", t);
        let e = "";
        throw (
          "/" === this._options.path &&
            this._options.host !== ex.CLOUD_HOST &&
            (e =
    ...
    async listAllPeers() {
      try {
        ...
        throw (
          eI.error("Error retrieving list peers", e),
  ...
  class eY extends eG {
    ...
    _initializeDataChannel(e) {
      ((this.dataChannel = e),
        ...
        (this.dataChannel.onmessage = (e) => {
          eI.log(`DC#${this.connectionId} dc onmessage:`, e.data);
        }),
        (this.dataChannel.onclose = () => {
          (eI.log(`DC#${this.connectionId} dc closed for:`, this.peer),
            this.close());
    ...
    constructor(e, t, n) {
      (super(e, t, n),
        (this.connectionId = this.options.connectionId || eY.ID_PREFIX + eE()),
  ...
  ((eY.ID_PREFIX = "dc_"), (eY.MAX_BUFFERED_AMOUNT = 8388608));
  class eK extends eY {
    get bufferSize() {
    ...
    _trySend(e) {
      ...
      if (this.dataChannel.bufferedAmount > eY.MAX_BUFFERED_AMOUNT)
        return (
          (this._buffering = !0),
          setTimeout(() => {
      ...
      try {
        ...
        return (
          eI.error(`DC#:${this.connectionId} Error when sending:`, e),
          (this._buffering = !0),
          this.close(),
          !1
        );
  ...
  class eZ extends eJ {
    ...
    _handleMessage(e) {
      ...
      switch (t) {
        ...
        case O.InvalidKey:
          ...
          break;
        case O.Leave:
          (eI.log(`Received leave message from ${r}`),
            this._cleanupPeer(r),
        ...
        case O.Offer: {
          ...
          if (
            (t &&
              (t.close(),
              eI.warn(`Offer received for existing Connection ID:${e}`)),
            n.type === w.Media)
          ) {
            let i = new eW(r, this, {
              connectionId: e,
            ...
            eI.warn(`Received malformed connection type:${n.type}`);
            return;
          }
        ...
        default: {
          if (!n) {
            eI.warn(`You received a malformed message from ${r} of type ${t}`);
            return;
          }
          ...
          o && o.peerConnection
            ...
            : i
              ...
              : eI.warn("You received an unrecognized message:", e);
        }
      }
    }
    _storeMessage(e, t) {
    ...
    call(e, t, n = {}) {
      ...
      let r = new eW(e, this, { ...n, _stream: t });
      return (this._addConnection(e, r), r);
    }
    _addConnection(e, t) {
      (eI.log(`add connection ${t.type}:${t.connectionId} to peerId:${e}`),
    ...
    destroy() {
      this.destroyed ||
        (eI.log(`Destroy peer with ID:${this.id}`),
        this.disconnect(),
        this._cleanup(),
        (this._destroyed = !0),
        this.emit("close"));
    ...
    disconnect() {
      ...
      let e = this.id;
      (eI.log(`Disconnect peer with ID:${e}`),
        (this._disconnected = !0),
        (this._open = !1),
        this.socket.close(),
    ...
    constructor(e, t) {
      ...
      if (
        ...
        (t = {
          ...
          path: "/",
          key: eZ.DEFAULT_KEY,
          token: ex.randomToken(),
          config: ex.defaultConfig,
        ...
        this._options.path &&
          ...
          "/" !== this._options.path[this._options.path.length - 1] &&
            (this._options.path += "/")),
        void 0 === this._options.secure && this._options.host !== ex.CLOUD_HOST
          ? (this._options.secure = ex.isSecure())
          : this._options.host == ex.CLOUD_HOST && (this._options.secure = !0),
        this._options.logFunction &&
          eI.setLogFunction(this._options.logFunction),
        (eI.logLevel = this._options.debug || 0),
        (this._api = new eH(t)),
        (this._socket = this._createServerConnection()),
        !ex.supports.audioVideo && !ex.supports.data)
      ) {
        this._delayedAbort(
